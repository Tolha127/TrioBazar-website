                    ...
                    <Link to={`/products/${product.id}`} className="product-link">
                      ...
                      <div className="product-info">
                        ...
                        {product.description && <p className="product-description">{product.description.length > 60 ? 
                          ...
                          href={`https://wa.me/2348120252838?text=Hello%20TrioBazaar,%20I'm%20interested%20in%20your%20${product.name}%20(Product%20Code:%20${product.code}).%20Please%20provide%20more%20information.`}
                          target="_blank"
